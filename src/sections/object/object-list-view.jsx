...
import ObjectNewForm from './object-new-edit-form';
...
export default function ObjectListView() {
  ...
  const { objects, create } = useGetObjects();
  // console.log(objects);
  ...
  return (
    <Container maxWidth={settings.themeStretch ? false : 'lx'}>
      ...
      <ObjectList objects={objects} onCreate={createModal.onTrue} />
      <ObjectNewForm open={createModal.value} onClose={createModal.onFalse} onCreate={create} />
    </Container>
  );
}
