...
import { useGetKassaBankCategories, useSearchKassaBankCategories } from 'src/api/payments';
...
export default function ContractExcelDialog({
  ...
  const [categoryTerm, setClientTerm] = useState('');
  const [categoryTermHelper, setClientTermHelper] = useState('');
      ...
      <FormProvider methods={methods} onSubmit={onSubmit}>
        ...
        <DialogContent dividers sx={{ position: 'relative' }}>
          <Stack spacing={2} pt={2}>
            ...
            />
            <RHFAutocomplete
              loading={categoryTerm?.length >= 3 ? searchLoading : kassBankCategoriesLoading}
              noOptionsText="Пусто"
