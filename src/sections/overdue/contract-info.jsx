...
export default function ContractInfo({ title, contract, sx, ...other }) {
      ...
      <Stack spacing={2}>
        ...
        <Stack direction="row" justifyContent="space-between">
          ...
          <Stack direction="row" gap={1} alignItems="center">
            ...
            <Label color={contract?.initial_payment_status === '1' ? 'success' : 'default'}>
              {contract?.initial_payment_status === '1' ? 'Оплачено' : 'Не оплачено'}
            </Label>
          </Stack>
        </Stack>
        <Stack direction="row" justifyContent="space-between">
