...
// export default function ContractsExcelDialog({
...
//       if (values.projectId) {
//         queryObject.project_id = values.projectId;
//       }

//       const query = queryString.stringify(queryObject);

//       const result = await axios.get(`/api/v1/contractlist/excel?${query}`);
...
//       saveAs(result?.data?.download_link, `Контракты-файл.xlsx`);
...
//   }, [methods.watch('projectId'), methods.watch('endDate'), methods.watch('startDate')]);
...
// ContractsExcelDialog.propTypes = {
...
export default function ContractsExcelDialog({
  ...
  const handleDownload = async () => {
    setLoadingExcelFile(true);
    try {
      const result = await axios.get('/api/v1/overduedays/excel');
