...
export default function PaymentsArrivalTableRow({
  row,
  selected,
  onSelectRow,
  onViewRow,
  ...
  return (
    <>
      ...
      >
        <TableCell>{fCurrency(arrival_amount)} UZS</TableCell>
        <TableCell>{fCurrency(moment_usd_rate)} UZS</TableCell>
        <TableCell>{fCurrency(arrival_amount / moment_usd_rate)} USD</TableCell>
...
PaymentsArrivalTableRow.propTypes = {
