...
import { useGetArrivalDetail } from 'src/api/warehouse';
...
export default function PaymentsTableRow({
  ...
  const { arrival, arrivalLoading } = useGetArrivalDetail(view.value ? row?.arrival_id : null);
  ...
  return (
    <>
      ...
      >
        ...
        <TableCell sx={{ color: makeColor(payment_amount) }}>
          {fCurrency(payment_amount)} UZS
        </TableCell>
