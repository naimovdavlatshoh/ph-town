...
export default function ArrivalPreivewFullscreenDialog({
  contractNumber,
  mode,
  open,
  handleClose,
  ...
  const { contractsLoading, create, createWithPlan } = useGetContracts();
...
ArrivalPreivewFullscreenDialog.propTypes = {
