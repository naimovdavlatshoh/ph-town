...
export default function ExpenditureExcelDialog({
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    try {
      ...
      const result = await axios.get(`/api/v1/expenditure/excel?${query}`);
      ...
      saveAs(result?.data?.download_link, `Расходы-файл.xlsx`);
...
ExpenditureExcelDialog.propTypes = {
