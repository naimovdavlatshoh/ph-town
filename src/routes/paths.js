...
export const paths = {
  ...
  // DASHBOARD
  dashboard: {
    root: `${ROOTS.DASHBOARD}/objects`,
    product2: `${ROOTS.DASHBOARD}/product2`,
    clients: {
      root: `${ROOTS.DASHBOARD}/clients`,
      new: `${ROOTS.DASHBOARD}/clients/new`,
      edit: (id) => `${ROOTS.DASHBOARD}/clients/${id}/edit`,
      details: (id) => `${ROOTS.DASHBOARD}/clients/details/${id}`,
    },
    home: {
    ...
    contracts: {
      ...
      new: (apartmentId) => `${ROOTS.DASHBOARD}/contracts/new/${apartmentId}`,
    ...
    overduecontract: {
      root: `${ROOTS.DASHBOARD}/overdue-contracts`,
    },
    payments: {
      root: `${ROOTS.DASHBOARD}/payments`,
      kassaSklad: `${ROOTS.DASHBOARD}/kassa-sklad`,
    ...
    contragents: {
      root: `${ROOTS.DASHBOARD}/contragents`,
    },
    realtors: {
      root: `${ROOTS.DASHBOARD}/realtors`,
    },
    checkboard: {
      details: (id) => `${ROOTS.DASHBOARD}/checkerboards/${id}`,
    },
    object: {
      root: `${ROOTS.DASHBOARD}/objects`,
      details: (id) => `${ROOTS.DASHBOARD}/objects/${id}`,
    },
    block: {
      details: (projcetId, blockId) => `${ROOTS.DASHBOARD}/blocks/${projcetId}/${blockId}`,
    },
    layout: {
      root: (projcetId) => `${ROOTS.DASHBOARD}/layouts/${projcetId}`,
    },
