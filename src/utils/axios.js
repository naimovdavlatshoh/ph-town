...
export const endpoints = {
  ...
  parking: {
    blockList: '/api/v1/parkingblocklist',
    blockInfo: '/api/v1/parkingblock/info',
    blockCreate: '/api/v1/parkingblock/create',
    blockUpdate: '/api/v1/parkingblock/update',
    blockDelete: '/api/v1/parkingblock/delete',
    floorList: '/api/v1/parkingfloorlist',
    floorInfo: '/api/v1/parkingfloor/info',
    floorCreate: '/api/v1/parkingfloor/create',
    floorUpdate: '/api/v1/parkingfloor/update',
    floorDelete: '/api/v1/parkingfloor/delete',
    spotList: '/api/v1/parkingspotlist',
    spotInfo: '/api/v1/parkingspot/info',
    spotCreate: '/api/v1/parkingspot/create',
    spotUpdate: '/api/v1/parkingspot/update',
    spotDelete: '/api/v1/parkingspot/delete',
  },
  visual: {
